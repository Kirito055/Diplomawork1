...
import time
from point.utils import plagiarism
...
class TextEditorView(generics.ListCreateAPIView):
    queryset = ProgrammingTaskSolution.objects.all()
    serializer_class = ProgrammingTaskSolutionSerializer
    template_name = 'other/textEditor.html'
...
def textEditor(request, slug):
    if request.method == 'GET':
        ...
        # else:
        #     return render(request, 'other/problempage.html')
    ...
    # else:
    #     return render(request, 'other/textEditor.html',
